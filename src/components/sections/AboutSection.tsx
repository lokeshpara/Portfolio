    ...
    <section id="about" style={{ paddingTop: '0.5rem' }}>
      <div style={{ marginLeft: '0.85rem' }}>
        ...
        <div className="space-y-0">
          <p className="pb-2 text-light-slate" style={{ fontSize: '0.80rem', textAlign: 'justify' }}>
          ...
          <p className="pb-2 mb-4 text-light-slate" style={{ fontSize: '0.80rem', textAlign: 'justify' }}>
          ...
          <p className="pb-2 mb-4 text-light-slate" style={{ fontSize: '0.8rem', textAlign: 'justify' }}>
          ...
          <p className="text-light-slate" style={{ fontSize: '0.8rem', textAlign: 'justify' }}>
